...
public class Pokesearch {
    public static String[] pokemon=new String[151],evolvefrom=new String[151];
	...
	Console c = new Console();
        ...
        while(true)
        {
            c.print("What pokemon do you want to search for: ");
            searchToken=c.readLine();
            if(searchToken=="q")break;
            index=findPoke(searchToken);
            if(index!=-1)
            c.print(pokemon[index] + " is evolved from " + evolvefrom[index] + "\n");
            else
            c.print("\"" + searchToken + "\"" + " was not found\n");
        }
        c.close();
    }
    public static int findPoke(String in)
    {
        int out=-1;
        for(int i=0;i<pokemon.length;i++)
        {
            if(in.equals(pokemon[i]))
            {
                out=i;
                break;
            }
